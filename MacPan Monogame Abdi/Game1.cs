...
namespace Pacman
{
    ...
    // Klassdefinition för Game1, som ärver från Game-klassen.
    public class Game1 : Game
    {
        // Statisk referens till spelkontrollinstansen.

        public static Controller gameController;
        // Grafikhantering och sprite batch för rendering.
        ...
        protected override void LoadContent()
        {
            ...
            Menu.setblob = Content.Load<Texture2D>("SpriteSheets/blob");
            Menu.setBasicFont = Content.Load<SpriteFont>("simpleFont");
            GameOver.setBasicFont = Content.Load<SpriteFont>("simpleFont");
            GameOver.setoutro = Content.Load<Texture2D>("SpriteSheets/outro");
